odoo.define('tobako_pos_keymap.ReceiptScreenKeymapped', function (require) {
    'use strict';
    ...
    var OriginalScreen = require('point_of_sale.ReceiptScreen');
