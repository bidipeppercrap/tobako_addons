odoo.define('tobako_pos_keymap.PaymentScreenKeymapped', function (require) {
    'use strict';
    ...
    var OriginalScreen = require('point_of_sale.PaymentScreen')
    ...
    PaymentScreen.template = 'PaymentScreenKeymapped';

    Registries.Component.add(PaymentScreen);

    OriginalScreen = PaymentScreen;
