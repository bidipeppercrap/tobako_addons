odoo.define('tobako_pos_receipt.TobakoReprintReceiptStateButton', function (require) {
    'use strict'

    const ReceiptScreen = require('point_of_sale.ReprintReceiptScreen')
    const Registries = require('point_of_sale.Registries')

    const TobakoReprintReceiptStateButton = (ReceiptScreen) => class extends ReceiptScreen {
        constructor() {
            super(...arguments)
        }
    ...
    Registries.Component.extend(ReceiptScreen, TobakoReprintReceiptStateButton)

    return TobakoReprintReceiptStateButton
})
